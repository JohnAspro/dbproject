...
create table focuses_on (
  ...
  constraint fk_scientific_field_name foreign key (scientific_field_name) references scientific_field (scientific_field_name) on delete restrict on update cascade
);
